...
const EndgamePanel = lazy(() => import('./CareerEndgamePanels').then((module) => ({ default: module.EndgamePanel })));
const CraftingPanel = lazy(() => import('./CareerCraftingPanels').then((module) => ({ default: module.CraftingPanel })));
